// Kudimata Invest — Wallet repository.
//
...
//
// BankAccountSummary itself lives in bank_accounts_repository.dart, not here
// — bank accounts are a real, standalone feature (a sell's payout / a buy's
// refund destination) independent of the wallet balance concept, and that
// repository is its natural home; reused here rather than duplicated.
//
// Construct with the ONE shared ApiClient:
//   final _repo = WalletRepository(AppScope.read(context).apiClient);
import '../api/api_client.dart';
import '../models.dart';
import 'bank_accounts_repository.dart' show BankAccountSummary;

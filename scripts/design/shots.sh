...
# build the artboard-annotated manifest, and print a summary an agent (or a
# human) can trust without re-deriving it.
#
# Usage:
...
#   build/shots/manifest.json                     — route/file/PNGs/artboard per screen + sub-state
set -euo pipefail
